  ...
  return (
        ...
        <div className="w-auto">
          ...
          <div className="mt-4">
            ...
            <label className="text-black font-medium mb-2 block mr-2">Product Description</label>
            <RiInformationLine
...
>
    ...
    <option value="item3">Item 3</option>
      ...
      <div className="relative">
        <FaDollarSign color='#000' className="absolute top-1/2 transform -translate-y-1/2 left-3" />
