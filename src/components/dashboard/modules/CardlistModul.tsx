...
const Card = ({ bgColor, title, amount, data }) => {
    ...
    return (
        <div className="w-full shadow-sm pl-6" >
        <div className="flex items-center justify-between mb-4"style={cardStyle}>
        ...
        <div className="flex items-center mb-2">
          ...
          <span className="text-gray-500 ml-1"><BsInfoCircle /></span>
        </div>
