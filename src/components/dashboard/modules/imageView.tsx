                ...
                {isFullScreen ? (
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75 z-50">
                        <div className="max-w-screen-lg">
                            <img src={imageUrl} alt="Full Screen" className="mx-auto max-h-full max-w-full" />
                            <button onClick={toggleFullScreen} className="absolute top-4 right-4 text-white focus:outline-none">
                                Close
                            </button>
                        </div>
                    </div>
                    ...
                    <>
                        <img src={imageUrl} alt="Card Image" className="w-full h-full object-cover rounded-lg" />
                        <div
